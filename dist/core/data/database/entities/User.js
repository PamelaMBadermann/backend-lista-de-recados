...
const Anottation_1 = require("./Anottation");
let User = class User extends typeorm_1.BaseEntity {
    constructor(username, password, uid, createdAt, updatedAt) {
        super();
...
__decorate([
    typeorm_1.OneToMany(type => Anottation_1.Anottation, anottation => anottation.user),
    __metadata("design:type", Array)
], User.prototype, "anottations", void 0);
__decorate([
